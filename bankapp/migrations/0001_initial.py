# Generated by Django 5.1 on 2024-09-18 12:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], max_length=45)),
                ('marital', models.CharField(choices=[('married', 'Married'), ('single', 'Single'), ('other', 'Other')], max_length=45)),
                ('phone_number', models.CharField(max_length=11)),
                ('state', models.CharField(max_length=300)),
                ('lga', models.CharField(max_length=300)),
                ('residential_address', models.CharField(max_length=200)),
                ('identity_type', models.CharField(choices=[('national_id_card', 'National ID Card'), ('drivers_license', 'Drivers License'), ('international_passport', 'International Passport')], max_length=140)),
                ('identity_image', models.ImageField(blank=True, null=True, upload_to='photo/')),
                ('passport', models.ImageField(upload_to='media/')),
                ('date_of_birth', models.DateTimeField()),
                ('signature', models.ImageField(upload_to='sign/')),
                ('next_of_kin', models.CharField(max_length=100)),
                ('kin_number', models.IntegerField()),
                ('account', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bankapp.account')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'userinfo',
